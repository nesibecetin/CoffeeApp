...
namespace ServiceReference3
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="ServiceReference3.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        ServiceReference3.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(ServiceReference3.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<ServiceReference3.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(ServiceReference3.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public ServiceReference3.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(ServiceReference3.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public ServiceReference3.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(ServiceReference3.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface KPSPublicSoapChannel : ServiceReference3.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<ServiceReference3.KPSPublicSoap>, ServiceReference3.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ServiceReference3.TCKimlikNoDogrulaResponse ServiceReference3.KPSPublicSoap.TCKimlikNoDogrula(ServiceReference3.TCKimlikNoDogrulaRequest request)
        {
        ...
        {
            ServiceReference3.TCKimlikNoDogrulaRequest inValue = new ServiceReference3.TCKimlikNoDogrulaRequest();
            inValue.Body = new ServiceReference3.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            ServiceReference3.TCKimlikNoDogrulaResponse retVal = ((ServiceReference3.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
            return retVal.Body.TCKimlikNoDogrulaResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceReference3.TCKimlikNoDogrulaResponse> ServiceReference3.KPSPublicSoap.TCKimlikNoDogrulaAsync(ServiceReference3.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceReference3.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            ServiceReference3.TCKimlikNoDogrulaRequest inValue = new ServiceReference3.TCKimlikNoDogrulaRequest();
            inValue.Body = new ServiceReference3.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            ...
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((ServiceReference3.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
